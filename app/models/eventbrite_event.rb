...
class EventbriteEvent
  ...
  def ticket_class_sold_out(code)
    ...
    return false if user_discount_code.nil?
    ...
    return true if no_tickets_to_buy

    available_ticket_classes = find_user_available_ticket_classes_by_status(user_ticket_class_ids, 'AVAILABLE')
  ...
  def find_user_available_ticket_classes_by_status(user_ticket_class_ids, status)
